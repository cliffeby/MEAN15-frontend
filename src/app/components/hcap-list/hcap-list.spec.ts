  ...
  const mockHcaps: HCap[] = [
    {
      ...
      scRating: 72,
      teeAbreviation: 'WH',
      rochIndexAfterRound: 12,
      differentialForRound: 8.3,
      courseAdjustedDifferentialForRound: 8.3,
    },
    {
      name: 'Bob',
      postedScore: 90,
